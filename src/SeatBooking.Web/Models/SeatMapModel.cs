...
public record SeatDto(
    ...
    [property: JsonPropertyName("limitations")] List<object> Limitations,
    [property: JsonPropertyName("refundIndicator")] string RefundIndicator,
    [property: JsonPropertyName("prices")] PriceDetailDto Prices,
    [property: JsonPropertyName("taxes")] PriceDetailDto Taxes,
    [property: JsonPropertyName("total")] PriceDetailDto Total,
    [property: JsonPropertyName("rawSeatCharacteristics")] List<string> RawSeatCharacteristics
);

public record PriceDetailDto(
    [property: JsonPropertyName("alternatives")] List<List<AmountDto>> Alternatives
);
...
public record PassengerInfoDto(
    ...
    [property: JsonPropertyName("phones")] List<string> Phones,
...
public record FlightDto(
    ...
    [property: JsonPropertyName("stopAirports")] List<string> StopAirports,
